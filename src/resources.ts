...
const RESOURCES: ResourcesConfig = {
  [Platform.ANDROID]: {
    ...
    [ResourceType.SPLASH]: {
      resources: [
        { src: 'android/splash/drawable-land-ldpi/splash.png', format: Format.PNG, width: 320, height: 240, density: Density.LAND_LDPI, orientation: Orientation.LANDSCAPE },
        { src: 'android/splash/drawable-land-mdpi/splash.png', format: Format.PNG, width: 480, height: 320, density: Density.LAND_MDPI, orientation: Orientation.LANDSCAPE },
        { src: 'android/splash/drawable-land-hdpi/splash.png', format: Format.PNG, width: 800, height: 480, density: Density.LAND_HDPI, orientation: Orientation.LANDSCAPE },
        { src: 'android/splash/drawable-land-xhdpi/splash.png', format: Format.PNG, width: 1280, height: 720, density: Density.LAND_XHDPI, orientation: Orientation.LANDSCAPE },
        { src: 'android/splash/drawable-land-xxhdpi/splash.png', format: Format.PNG, width: 1600, height: 960, density: Density.LAND_XXHDPI, orientation: Orientation.LANDSCAPE },
        { src: 'android/splash/drawable-land-xxxhdpi/splash.png', format: Format.PNG, width: 1920, height: 1280, density: Density.LAND_XXXHDPI, orientation: Orientation.LANDSCAPE },
        { src: 'android/splash/drawable-port-ldpi/splash.png', format: Format.PNG, width: 240, height: 320, density: Density.PORT_LDPI, orientation: Orientation.PORTRAIT },
        { src: 'android/splash/drawable-port-mdpi/splash.png', format: Format.PNG, width: 320, height: 480, density: Density.PORT_MDPI, orientation: Orientation.PORTRAIT },
        { src: 'android/splash/drawable-port-hdpi/splash.png', format: Format.PNG, width: 480, height: 800, density: Density.PORT_HDPI, orientation: Orientation.PORTRAIT },
        { src: 'android/splash/drawable-port-xhdpi/splash.png', format: Format.PNG, width: 720, height: 1280, density: Density.PORT_XHDPI, orientation: Orientation.PORTRAIT },
        { src: 'android/splash/drawable-port-xxhdpi/splash.png', format: Format.PNG, width: 960, height: 1600, density: Density.PORT_XXHDPI, orientation: Orientation.PORTRAIT },
        { src: 'android/splash/drawable-port-xxxhdpi/splash.png', format: Format.PNG, width: 1280, height: 1920, density: Density.PORT_XXXHDPI, orientation: Orientation.PORTRAIT },
